...
import { getCartTotal, updateItemQuantity, removeItemFromCart, clearCart } from '../utils/cartUtils';
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white dark:bg-slate-800 rounded-lg p-6 max-w-md w-full mx-4 max-h-[90vh] overflow-auto">
            ...
            <div key={item.menuItemId} className="py-4">
              <div className="flex justify-between">
                ...
                <div className="flex items-center">
                  <button
                    onClick={() => handleUpdateQuantity(item.menuItemId, item.qty - 1)}
        ...
        <div className="border-t border-gray-200 dark:border-gray-700 pt-4 mt-4">
          ...
          {/* Added Continue Shopping button for non-empty cart */}
          <button
            onClick={handleContinueShopping}
            className="w-full py-2 border border-green-500 text-green-500 rounded-md hover:bg-green-50 dark:hover:bg-green-900/20 mt-3"
          >
            Continue Shopping
          </button>
        </div>
